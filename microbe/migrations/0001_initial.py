...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["name"], name="microbe_sa_name_b0e467_idx"),
        ),
        migrations.AddField(
            model_name="sampleannotation",
            name="projects",
            field=models.ManyToManyField(
                related_name="annotations", to="microbe.project"
            ),
        ),
        migrations.AddField(
            model_name="sampleannotation",
            name="samples",
            field=models.ManyToManyField(
                related_name="annotations", to="microbe.sample"
            ),
        ),
        migrations.AddField(
            model_name="sample",
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="microbe.project"
            ),
        ),
    ]
