...
from microbe.models import ViralCatalogue, GenomeCatalogue
from microbe.tests.conftest import (
...
class WebsiteTests(StaticLiveServerTestCase):
    ...
    def test_web(self, m):
        ...
        m.get(
            microbe_config.metabolights.api_root
        ...
        assert "MICROBE Data Portal API" in body.text
        ...
        m.get(
            f"{microbe_config.docs.docs_url}/search.json",
            json=[],
        )
