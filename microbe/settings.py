"""Django settings for MICROBE data portal project.
...
microbe_config_env = os.getenv("MICROBE_ENV_FILE")
if microbe_config_env:
    logging.warning(f"Using environment from {microbe_config_env}")
MICROBE_CONFIG = MicrobeConfig(_env_file=microbe_config_env)
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "microbe.context_processors.apis",
            ],
        },
    },
]

WSGI_APPLICATION = "microbe.wsgi.application"
