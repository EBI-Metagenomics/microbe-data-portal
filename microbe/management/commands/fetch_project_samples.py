...
from microbe.external_apis.biosamples.api import get_project_samples
from microbe.models import Animal, Sample
...
class Command(BaseCommand):
    ...
    def get_system(sample: dict) -> Optional[str]:
        for system_characteristic in ["host tax id", "host taxid", "Organism"]:
            ...
            system = microbe_config.ena.systems.get(characteristic_value)
            if system:
                return system
        return None
